...
# Training settings
parser = argparse.ArgumentParser(description='PyTorch MiniImageNet20 Example')
...
parser.add_argument('--ckpt', type=str, default="/tmp/user/cifar/")
parser.add_argument('--log-dir')
parser.add_argument('--adv-ex-dir')
parser.add_argument('--fingerprint-dir')
parser.add_argument('--data-dir', type=str, default="/tmp/user/cifar/")
...
test_set_path = os.path.join(args.adv_ex_dir,'Random_Test_%s_.p' % ('miniimagenet20'))
...
random_loader = torch.utils.data.DataLoader(
    ...
    batch_size=args.batch_size, shuffle=False, **kwargs)
"""
list_advs = ["iterativefgsm","fgsm"] # ['fgsm']
